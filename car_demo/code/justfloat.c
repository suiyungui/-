...
//u1_printf("%f\r\n",a);
uart_write_buffer(UART_0,byte,4);   //1转化为4字节数据 就是  0x00 0x00 0x80 0x3F
//发送帧尾
uart_write_buffer(UART_0,tail,4);   //帧尾为 0x00 0x00 0x80 0x7f
}
//-------------------------------------------------------------------------------------------------------------------
...
uart_write_buffer(UART_0,byte,4);   //2转换为4字节数据 就是  0x00 0x00 0x00 0x40
